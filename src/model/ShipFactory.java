...
public class ShipFactory {
    ...
    private Byte[] numShipsArray = new Byte[] {2,3,4,5};
    private Byte[] maxShipsArray = new Byte[] {3,4,5};
    private Random rand = new Random();
    private List<Integer> fieldArray = new ArrayList<>();


    public Byte[] getNumShipsArray() { return numShipsArray; }
    public Byte[] getMaxShipsArray() { return maxShipsArray; }
    public Byte getBoardSize() { return boardSize; }

    public List<Ship> createFleet(byte numberShips, byte shipSizeMax)  {
